...
public class CuerposGeometricos {
    ...
    public static void AreaVolumen(double AreaC, double Ar, double Volc, double rad, double Rad, double v, double H) { // 7
        ...
        // Resultados
        System.out
                .println("El Area del Casquete en funcion del Radio de la esfera es: " + AreaC + " Unidades Cuadradas");
        System.out.println("El Area del Casquete en funcion del radio menor es: " + Ar + " Unidades Cuadradas");

        System.out
                .println("El Volumen del Casquete en funcion del Radio de la esfera es: " + Volc + " Unidades Cubicas");
